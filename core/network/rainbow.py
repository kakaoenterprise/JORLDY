...
class Rainbow(BaseNetwork):
    def __init__(self, D_in, D_out, N_atom, D_hidden=512, header=None):
        D_in, D_hidden = super(Rainbow, self).__init__(D_in, D_hidden, header)
        self.D_out = D_out
        self.N_atom = N_atom
        ...
        self.mu_w_a2, self.sig_w_a2, self.mu_b_a2, self.sig_b_a2 = init_weights((D_hidden, N_atom * self.D_out))
        self.mu_w_v2, self.sig_w_v2, self.mu_b_v2, self.sig_b_v2 = init_weights((D_hidden, N_atom))
