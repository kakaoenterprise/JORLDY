...
class Rainbow(BaseNetwork):
    def __init__(self, D_in, D_out, N_atom, noise_type, D_hidden=512, head='mlp'):
        ...
        self.mu_w_a2, self.sig_w_a2, self.mu_b_a2, self.sig_b_a2 = init_weights((D_hidden, N_atom * self.D_out), noise_type)
        self.mu_w_v2, self.sig_w_v2, self.mu_b_v2, self.sig_b_v2 = init_weights((D_hidden, N_atom), noise_type)
    ...
    def forward(self, x, is_train):
        ...
        x_a = noisy_l(x_a, self.mu_w_a2, self.sig_w_a2, self.mu_b_a2, self.sig_b_a2, self.noise_type, is_train) # [bs, num_action * N_atom]
        ...
        x_v = noisy_l(x_v, self.mu_w_v2, self.sig_w_v2, self.mu_b_v2, self.sig_b_v2, self.noise_type, is_train) # [bs, N_atom]
