...
class Rainbow(torch.nn.Module):
    def __init__(self, D_in, D_out, num_atom, D_hidden=128):
        ...
        self.mu_w_a2, self.sig_w_a2, self.mu_b_a2, self.sig_b_a2 = init_weights((self.D_hidden, self.Num_atom * self.D_out))
        self.mu_w_v2, self.sig_w_v2, self.mu_b_v2, self.sig_b_v2 = init_weights((self.D_hidden, self.Num_atom))
    ...
    def forward(self, x, is_train):
        ...
        x_a = noisy_l(x_a, self.mu_w_a2, self.sig_w_a2, self.mu_b_a2, self.sig_b_a2, is_train) # [bs, num_action * num_atom]
        ...
        x_v = noisy_l(x_v, self.mu_w_v2, self.sig_w_v2, self.mu_b_v2, self.sig_b_v2, is_train) # [bs, num_atom]
...
class Rainbow_CNN(torch.nn.Module):
    def __init__(self, D_in, D_out, Num_atom):
        ...
        self.mu_w_a2, self.sig_w_a2, self.mu_b_a2, self.sig_b_a2 = init_weights((512, self.Num_atom * self.D_out))
        self.mu_w_v2, self.sig_w_v2, self.mu_b_v2, self.sig_b_v2 = init_weights((512, self.Num_atom))
